  ...
  return (
    <div className="p-8 max-w-3xl">
      ...
      <div className="space-y-6">
        {grouped.map(({ eng, items }) => (
          <div key={eng.id}>
            <h2 className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-2">{eng.clientName}</h2>
            <div className="bg-white border border-gray-100 rounded-xl divide-y divide-gray-50">
              {items.map(d => (
                <div key={d.id} className="flex items-center gap-3 px-4 py-3">
                  ...
                  <span className={`flex-1 text-sm ${d.done ? 'line-through text-gray-400' : 'text-gray-800'}`}>{d.title}</span>
        ...
        {ungrouped.length > 0 && (
          <div>
            <h2 className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-2">Other</h2>
            <div className="bg-white border border-gray-100 rounded-xl divide-y divide-gray-50">
              {ungrouped.map(d => (
                <div key={d.id} className="flex items-center gap-3 px-4 py-3">
